...
public:
    Poison(int mouse_x = 0, int mouse_y = 0) : Tower(mouse_x, mouse_y)
    {
        ...
        HealthPoint = 5000;
        HP_STAY = 5000;
        img = al_load_bitmap("./Tower/Poison/Poison.png");
        img_b = al_load_bitmap("./Tower/Poison/Poison_b.png");
        img_w = al_load_bitmap("./Tower/Poison/Poison_w.png");
        img_c = al_load_bitmap("./Tower/Poison/Poison_c.png");
        attack_img = al_load_bitmap("./Tower/Poison/Poison_Beam.png");
    }
